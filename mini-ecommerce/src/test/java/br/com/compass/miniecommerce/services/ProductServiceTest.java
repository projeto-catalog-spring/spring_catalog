...
public class ProductDtoTest {
	...
	private ProductReqDto productDTOres;
	...
	public void editProduct() {
		when(prodServ.editProduct(product.getId(), productDTO, uri)).thenReturn(null).thenThrow(new IllegalArgumentException());
		assertEquals(product, product);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void removeProduct() {
		when(prodServ.removeProduct(product.getId(), true, uri)).thenReturn(null).thenThrow(new IllegalArgumentException());
